...
EXAMPLES = [
    ...
    ("Market Information",  "market_information/oi_data.py",                   ["--expiry", NEXT_TUE]),
    ("Market Information",  "market_information/change_oi.py",                 ["--expiry", NEXT_TUE, "--interval", "5"]),
    ("Market Information",  "market_information/max_pain.py",                  ["--expiry", NEXT_TUE, "--bucket-interval", "60"]),
    ("Market Information",  "market_information/pcr_data.py",                  ["--expiry", NEXT_TUE, "--bucket-interval", "60"]),
]
